...
usa <- raster::shapefile("../../../intermediate_data_output/base_map/usa_base.shp") # in case the server for downloading the base map is down, have it pre-downloaded and stored in the "base_map" folder in the "intermediate_data_output" folder on github

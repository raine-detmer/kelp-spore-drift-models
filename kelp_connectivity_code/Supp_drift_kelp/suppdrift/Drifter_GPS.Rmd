...
usa <- raster::shapefile("../../../intermediate_data_output/base_map/usa_base.shp") # in case the server for downloading the base map is down, the base map was pre-downloaded and put in the "base_map" folder on github
